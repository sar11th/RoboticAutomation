...
##    Handle Alert    action=ACCEPT
    ...
    Wait Until Page Contains Element    ${backtobookdetails}
    Click Button    ${backtobookdetails}
    sleep    3s
    Execute JavaScript    window.scrollTo(0, document.body.scrollHeight)
#    scroll element into view    ${click_programming}
...
#    sleep    5s
#    sleep    10s
#    scroll element into view    ${delete_all_books}
    Execute JavaScript    window.scrollTo(0, document.body.scrollHeight)
    sleep    10s
